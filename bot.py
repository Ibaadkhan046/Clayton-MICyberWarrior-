...
// Functionality to generate and display random user agents
for ($i = 0; $i < 5; $i++) {
    $userAgent = generateUserAgent();
    echo printColored("Generated User-Agent $i: ", $yellow) . $userAgent . "\n";
    sleep(2); // Simulate delay between generations
}
}
from aiohttp import (
    ClientResponseError,
